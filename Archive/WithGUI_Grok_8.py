...
def create_arps_plot(df_well, t, q, mask, popt, well_id, df_full, q_original, q_smoothed, 
                     ...
                     show_smoothed=False, show_channel=False, forecast_duration=60):  # Changed show_smoothed default to False, added show_channel, added forecast_duration
    if popt is None:
...
def run_arps_for_well_auto(df_all, well_name, outlier_threshold=2, 
                           ...
                           forecast_duration=60):  # Added show_channel parameter and forecast_duration
    df_well = df_all[df_all['Well_Name'] == well_name].copy()
    if df_well.empty:
    ...
    fig = create_arps_plot(df_well, t, q, mask, popt, well_name, df_full, 
                           ...
                           show_smoothed, show_channel, forecast_duration)  # Added show_channel parameter and forecast_duration
            ...
            if pbounds:
                ...
                try:
                    ...
                    fig, results = run_arps_for_well_auto(
                        ...
                        show_channel=show_channel, forecast_duration=forecast_duration  # Add this parameter
                    )
